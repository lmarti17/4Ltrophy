...
<div class="wrapper">
	...
	<div id="association">
		...
		<div class="row">
			...
			<div class="col-md-4  ">
				<img src="assets/Maroc.svg" alt="Maroc" class="kid" >
			</div>

			<div class="col-md-8 spacement2">
		...
		<div class="row icons">
			...
			<div class="col-md-4"> 
				<img src="assets/panneau.svg" alt="Maroc" class="pictogram1" >
				<h1>73</h1>
				<h3>INSTALLATIONS  FOTOVOLTAÏQUES </h3>
			</div>

			<div class="col-md-4"> 
				<img src="assets/outils.svg" alt="outils" class="pictogram2" >
				<h1>200 000</h1>
				<h3>ENFANTS ÉQUIPÉS  DE MATÉRIEL SCOLAIRE </h3>
			</div>

			<div class="col-md-4"> 
				<img src="assets/doctor.svg" alt="doctor" class="pictogram3" >
				<h1>4814</h1>
		...
		<a href="index.php">
			<img src="assets/buttons/participons.png" alt="participons" class="participatebutton">
		</a>
	</div>
</div>
